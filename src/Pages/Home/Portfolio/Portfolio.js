                ...
                <div className="px-3 pt-3 py-lg-5">
                    <div className="d-flex flex-column flex-lg-row py-5">
                        ...
                        <div className="w-100 text-lg-end mt-4 mt-lg-0 pe-lg-5 pro-inf-wrap">
                            ...
                            <Button onClick={() => handleNavigate(1)} className="btn theme-button py-2 px-4 my-4">Details</Button>
                        </div>
                    </div>
                </div>
                <div className="px-3">
                    <div className="d-flex flex-column flex-lg-row py-lg-5">
                        <div className="w-100 pe-lg-5">
                            ...
                            <Button onClick={() => handleNavigate(2)} className="btn theme-button py-2 px-4 my-4">Details</Button>
                        </div>
                ...
                <div className="px-3 py-3">
                    <div className="d-flex flex-column flex-lg-row py-5">
                        ...
                        <div className="w-100 text-lg-end mt-4 mt-lg-0 pe-lg-5 pro-inf-wrap">
                            ...
                            <Button onClick={() => handleNavigate(3)} className="btn theme-button py-2 px-4 my-4">Details</Button>
                        </div>
                    </div>
                </div>
            </Container>
